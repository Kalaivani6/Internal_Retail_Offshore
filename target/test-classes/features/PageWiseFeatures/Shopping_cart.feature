...
@RTD-1520
Scenario: Validation of Print button in Cart Page through Scan flow
	Given I am in Shopping cart Page through Scan flow 
...
@runnewaug0311
Scenario: Validation of Print button in Cart Page through Verify flow
	Given I am in Shopping cart Page through Verify flow 
	When I click Print button
	Then I see the print details page
...
@runnewaug0311	
Scenario: Validation of Payment Details button by clicking Edit Cart(Top) button in Cart Page through Verify flow
	Given I am in Shopping cart Page through Verify flow
	When I click Edit cart at top of the cart summary
	Then I see Edit order Page
	When I click Payment Details button
...
@runnewaug0322	
Scenario: Validation of Payment Details button by clicking Edit Cart(Bottom) button in Cart Page through Verify flow
	Given I am in Shopping cart Page through Verify flow
	When I click Edit cart at bottom of the cart summary
	Then I see Edit order Page
	When I click Payment Details button
...
@runnewaug04	
Scenario: Validation of Line Details button by clicking Edit Cart(Top) button in Cart Page through Verify flow
	Given I am in Shopping cart Page through Verify flow
	When I click Edit cart at top of the cart summary
	Then I see Edit order Page
	When I click Line Details button
...
@runnewjuly3122 @runnewaug0311
Scenario: Validation of Continue Customization by clicking Cart Icon in Device Config Page through Verify flow
	Given I am in Device Config Page through Verify flow
	When I click Cart Icon to see Shopping Cart Page
	#Then I see the Shopping Cart Page	
	When I select Continue Customization
	Then I see the Device Config Page
...
@runnewjuly3122 @runnewaug0311	
Scenario: Validation of Delete Line by clicking Cart Icon in Device Config Page through Verify flow
	Given I am in Device Config Page through Verify flow
	When I click Cart Icon to see Shopping Cart Page
	When I select Delete Line
	Then I see the cart text
	
@runnewaug0111 @runnewaug0311
Scenario: Validation of Add a Line button after deleting a line by clicking Cart Icon in Device Config Page through Verify flow
	Given I am in Device Config Page through Verify flow
	When I click Cart Icon to see Shopping Cart Page
	When I select Delete Line
	Then I see the cart text
...
@runnewaug0122 @runnewaug0322	
Scenario: Validation of Back Arrow by clicking Cart Icon in Device Config Page through Verify flow
	Given I am in Device Config Page through Verify flow
	When I click Cart Icon to see Shopping Cart Page
	When I click Back Arrow
	Then I see the Device Config Page
