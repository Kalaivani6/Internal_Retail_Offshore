...
@Validateinfo @adet @runnewaug0222
...
@verifycomaprebills @runnewaug0211
...
@runnewaug0222
Scenario: Verify the Mobile Details text 
Given I am in Device details page
Then I see the Mobile Details section

@verifynotetype @runnewaug0266
