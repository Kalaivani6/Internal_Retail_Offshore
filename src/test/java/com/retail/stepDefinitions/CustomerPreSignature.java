...
public class CustomerPreSignature extends CustomerPreSignaturePage{
	...
	public  void placeOrder() throws Exception {
		try {		
			...
			WebDriverWait wait = new WebDriverWait(getDriver(),700);
			wait.until(ExpectedConditions.presenceOfElementLocated(OrderConfirmationPage.success));
//			if(isElementDisplayed(CustomerPreSignaturePage.generateOrder, 120))
//			{ log.info("Generating Order text is displayed");
//			}			
